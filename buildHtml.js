...
const CONSENT_TEXTS = [
  "본 계약은 전자문서 및 전자거래 기본법 제4조 및 전자서명법 제3조에 의거하여 서면 계약과 동일한 법적 효력을 가집니다. OTP(일회용 비밀번호) 인증을 통한 본인 확인은 전자서명법 제2조 제2호에 따른 전자서명에 해당하며 법적 효력을 가집니다.",
...
<body>
  <div class="doc">
    ...
    <div class="legal-box">
      ...
      <p class="legal-item"><strong>개인정보 수집·이용.</strong> 이름, 전화번호, 서명 이미지, 계약 정보를 계약 체결일로부터 5년간 보관합니다.</p>
