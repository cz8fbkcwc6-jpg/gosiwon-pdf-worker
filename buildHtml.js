...
const CONSENT_TEXTS = [
  "본 계약은 전자문서 및 전자거래 기본법 제4조 및 전자서명법 제3조에 의거하여 서면 계약과 동일한 법적 효력을 가질 수 있습니다. OTP(일회용 비밀번호) 인증을 통한 본인 확인은 전자서명법 제2조 제2호에서 정하는 전자서명에 준하는 방식으로, 당사자 간 합의에 의해 법적 효력을 가질 수 있습니다.",
  ...
  "본 계약은 터TOOL이 제공하는 전자계약 서비스를 통해 체결되며, 터TOOL은 기술적 플랫폼을 제공할 뿐 계약의 당사자가 아닙니다. 계약 내용의 적법성 및 이행에 관한 책임은 계약 당사자(원장 및 입주민)에게 있습니다.",
  "계약 체결 및 분쟁 대응을 위하여 아래 개인정보를 수집·이용·보관함에 동의합니다.\n· 수집 항목: 이름, 전화번호, 서명 이미지, 계약 정보\n· 이용 목적: 전자계약 체결, 본인 확인, 분쟁 해결\n· 보유 기간: 서비스 탈퇴 또는 계약 해지 시 삭제.\n단, 관련 법령에 따라 보존이 필요한 경우 해당 기간 동안 보관될 수 있음\n· 제3자 제공: 없음\n(단, 서비스 운영을 위한 처리위탁 제외:\n데이터 저장·SMS 발송 등 기술 인프라 서비스)",
];
...
<body>
  <div class="doc">
    ...
    <div class="legal-box">
      <p class="legal-item"><strong>법적 효력.</strong> 본 문서는 전자문서 및 전자거래 기본법 제4조, 전자서명법 제3조에 의거하여, 당사자가 앱을 통해 내용을 확인·동의하고 휴대전화 SMS 인증(OTP)으로 본인 확인을 마친 경우 서면 계약과 동일한 법적 효력을 가질 수 있습니다.</p>
      ...
      <p class="legal-item"><strong>개인정보 수집·이용.</strong> 이름, 전화번호, 서명 이미지, 계약 정보는 서비스 탈퇴 또는 계약 해지 시 삭제되며, 관련 법령에 따라 필요한 경우 별도 보관될 수 있습니다.</p>
